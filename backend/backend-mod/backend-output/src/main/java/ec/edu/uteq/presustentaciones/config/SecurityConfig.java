...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .csrf(csrf -> csrf.disable()) // Sigue siendo vital para permitir POST
    ...
    public UrlBasedCorsConfigurationSource corsConfigurationSource() {
        ...
        config.setMaxAge(3600L); // Cache de 1 hora para evitar re-validar cada segundo
    ...
    public PasswordEncoder passwordEncoder() {
        // Este Bean es el que permite comparar tu clave plana con el hash de la BD
